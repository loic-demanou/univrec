...
Route::get('downloadattachment/{file}', [JobController::class, 'download']); //->name('attachment.download');
Route::get('viewattachment/{is}', [JobController::class, 'view']); //->name('attachment.download');
...
Route::group(['middleware'=> ['auth']], function(){
    ...
    Route::post('/appointment/{proposal}', [ProposalController::class, 'schedule'])->name('appointment.schedule');
