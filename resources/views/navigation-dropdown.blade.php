        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @auth
                    ...
                    <!-- ICON -->
                    <div class="dropdown nav-button notifications-button hidden-sm-down mt-2">
                                        ...
                                        {{-- <a class="dropdown-item dropdown-notification" href="{{ href }}">
                                            ...
                                            <div class="notifications-body">
                                                <p class="notification-texte mx-1">
                                                    <small><span
                                                            class="badge badge-pill badge-dark">#{{ $notification->data['job_id'] }}</span>
                                                        {{ $notification->data['affected_by']}}
                                                        t'a affecté le job {{ $notification->data['job_title']}}</small>
                                                </p>
                                            </div>
                ...
                @if (Auth::user())
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('conversation.index') }}"
                            :active="request()->routeIs('conversation.index')">
                            {{ __('Chats') }}
                        </x-jet-nav-link>
                    </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('candidates.list') }}"
                        :active="request()->routeIs('candidates.list')">
                        {{ __('Candidates') }}
                    </x-jet-nav-link>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user())
                ...
                <x-jet-responsive-nav-link href="{{ route('conversation.index') }}"
                    :active="request()->routeIs('conversation.index')">
                    {{ __('Chats') }}
                </x-jet-responsive-nav-link>
            ...
            <x-jet-responsive-nav-link href="{{ route('candidates.list') }}"
