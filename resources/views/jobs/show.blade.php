    ...
    <div class="row">
            ...
            <div class="">
                <div class="px-3 py-3 mb-5 hover:shadow-lg rounded border border-gray-500 bg-gray-200">
                    <span class="text-sm text-gray-600 d-flex mb-2">
                        ...
                        class="rounded-circle mr-3" alt="{{ Auth::user()->name }}" style="width: 25px; height: 25px">
                    ...
                    <span class="text-md text-gray-600"><i class="fa fa-link mr-3 " style="font-size:17px">Type of contract : </i>
                        {{ $jobs->job_type }}
                    </span><br>
                    <span class="text-md text-gray-600 mr-2"><i class="fa fa-link mr-3 " style="font-size:17px">attachment</i>
                        {{-- <a href="{{ url('/viewattachment', $jobs->attachment) }}"> View</a> --}}
                        <a href="{{ url('/downloadattachment', $jobs->attachment) }}"><i class="fas fa-download"></i> Download</a>
                    </span>

                    <div class="text-md text-gray-600 mt-2 ">Number of post available : {{ $jobs->number }}</div>
        ...
        <div class="col-md-4 col-sm-12 mb-4">
            ...
            <div class="d-flex">
                ...
                <img src="{{ Auth::user()->profile_photo_url }}" width="60px"
                class="rounded-circle mr-3" alt="{{ Auth::user()->name }}" style="width: 100px; height:100px" id="img">
