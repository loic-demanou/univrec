        ...
        <form action="{{ route("jobs.update", $jobs->id) }}" method="post">
            ...
            <div class="row hover:shadow-lg border border-gray-500 bg-white py-4"style="margin-top:4%; border-radius: 15px;">
                <div class="form-group col-md-6" >
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control @error('qualification') is-invalid @enderror" name="qualification"
                            value="{{ $jobs->qualification }}" autocomplete="qualification" autofocus placeholder="eg:M.Se/M.Eng">
                        @error('qualification')
                            <span class="text-red-500 text-sm block" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control @error('speciality') is-invalid @enderror" name="speciality"
                            value="{{ $jobs->speciality }}" autocomplete="speciality" autofocus placeholder="eg:Computer engineering">
                        @error('speciality')
                            <span class="text-red-500 text-sm block" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control @error('post') is-invalid @enderror" name="post" 
                            value="{{ $jobs->post }}" autocomplete="post" autofocus placeholder="eg:Teacher">
                        @error('post')
                            <span class="text-red-500 text-sm block" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group col-md-6">
                    ...
                    @error('attachment')
                        <span class="text-red-500 text-sm block" role="alert"></span>
                        <strong>{{ $message }}</strong>
                    @enderror
                    <br>
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="job_type" class="form-control @error('job_type') is-invalid @enderror">
                            <option>--choose a contract type--</option>
                    ...
                    <div class="col-md-6">
                        ...
                        value="{{ $jobs->number }}" autocomplete="number" autofocus>
                        @error('number')
                            <span class="text-red-500 text-sm block" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
